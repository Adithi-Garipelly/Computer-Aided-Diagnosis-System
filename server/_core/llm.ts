...
export async function invokeLLM(params: InvokeParams): Promise<InvokeResult> {
  ...
  if (!hasKey) {
    console.warn("LLM API key missing, returning mock data");
    return {
      id: "mock-id",
      created: Date.now(),
      ...
      choices: [{
        ...
        message: {
          ...
          content: JSON.stringify({
            ...
            metrics: { bloodGlucose: "150", hba1c: "7.2" },
            conditions: ["Type 2 Diabetes"],
            riskLevel: "moderate",
            confidencePercentage: 82,
            diagnosticSummary: "Based on the metrics, the patient has a moderate risk. Continued monitoring of blood glucose and HbA1c is advised."
          })
        },
        finish_reason: "stop"
      }]
